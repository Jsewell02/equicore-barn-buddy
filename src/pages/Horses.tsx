...
// Import the updated Airtable hooks instead of mock data
import { useHorsesData } from "@/hooks/useAirtableActions";
import { format } from "date-fns";
import React from "react";

const Horses = () => {
  // Use the Airtable integration instead of mock data
  const { horses, loading, error, refetch } = useHorsesData("demo");
  const [selectedHorse, setSelectedHorse] = useState(horses[0]);
  const [showVetModal, setShowVetModal] = useState(false);

  // Update selected horse when horses data loads
  React.useEffect(() => {
      ...
      <div className="min-h-screen bg-gradient-meadow">
        ...
        <div className="lg:pl-72">
          <PageHeader 
            ...
            subtitle="Loading horses from Airtable..."
          />
    ...
    return (
      <div className="min-h-screen bg-gradient-meadow">
        ...
        <div className="lg:pl-72">
          <PageHeader 
            title="Horse Management" 
            subtitle="Error loading horses from Airtable"
          />
          ...
          <div className="p-4 lg:p-8">
            <Card className="bg-destructive/5 border-destructive/20">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Error Loading Horses</h3>
    ...
    return (
      <div className="min-h-screen bg-gradient-meadow">
        ...
        <div className="lg:pl-72">
          <PageHeader 
            title="Horse Management" 
            subtitle="No horses found in your Airtable base"
            action={
            ...
            <Card className="bg-gradient-card shadow-barn">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground mb-4">
                  Add your first horse to get started with the barn management system.
                </p>
                <Button variant="barn" className="gap-2">
                  <Plus className="w-4 h-4" />
                  Add Horse
  ...
  return (
    <div className="min-h-screen bg-gradient-meadow">
      ...
      <div className="lg:pl-72">
        <PageHeader 
          title="Horse Management" 
          subtitle={`Monitor health, feeding, and care for all your horses (${horses.length} total)`}
          action={
